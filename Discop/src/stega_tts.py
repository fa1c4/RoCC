...
def encode_speech(vocoder,
    ...
    single_encode_step_output, sr = vocoder.encode_speech(mel, message_bits, tqdm_desc=tqdm_desc)

    return single_encode_step_output, sr


def decode_speech(vocoder,
                  tacotron,
                  cmudict,
                  speech,
                  text: str,
    ...
    message_decoded = vocoder.decode_speech(mel, speech)
